"""calendar: create calendar projection tables for workspace persistence

Revision ID: core_003
Revises: core_002
Create Date: 2026-03-26 00:00:00.000000

Collapsed from: core_005_add_calendar_projection_tables.

Creates per-butler calendar tables (no schema prefix):
  - calendar_sources
  - calendar_events
