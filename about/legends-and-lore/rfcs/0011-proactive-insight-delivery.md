...
- **`public.attention_daily_rollup`** (migration `core_164`) — one row per UTC day: `day` (PK), `owner_ingress_count`, `insights_delivered`, `insights_engaged`, `updated_at`. Two independent writers populate it:
