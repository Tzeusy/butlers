...
# ---------------------------------------------------------------------------
# Ingestion event lineage models
# ---------------------------------------------------------------------------
...
class IngestionEventSummary(BaseModel):
    ...
    Returned by GET /api/switchboard/ingestion/events.
    """

    id: str  # UUIDv7 string — the request_id
...
class IngestionEventSession(BaseModel):
    ...
    Returned as part of GET /api/switchboard/ingestion/events/{request_id}/sessions.
    """
...
class IngestionEventRollup(BaseModel):
    ...
    Returned by GET /api/switchboard/ingestion/events/{request_id}/rollup.
    """
    ...
    by_butler: dict[str, ButlerRollupEntry] = {}
