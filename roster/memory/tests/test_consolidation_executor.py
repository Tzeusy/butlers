...
_EXECUTOR_PATH = (
    __import__("pathlib").Path(__file__).resolve().parent.parent / "consolidation_executor.py"
)

_PARSER_PATH = (
    __import__("pathlib").Path(__file__).resolve().parent.parent / "consolidation_parser.py"
)
