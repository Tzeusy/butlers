...
import { VISUAL_TOKEN_ROLE_REGISTRY } from "@/lib/visual-token-roles"
 ...
 * KNOWN_BUTLERS. The identity family is owned by the visual-role registry;
 * its order plus KNOWN_BUTLERS below forms the executable butler->hue
 * mapping. See openspec/specs/dashboard-design-language/spec.md § Requirement:
 * Butler Category Hues for the mirrored table, which MUST be regenerated by
 * hand whenever either source changes.
 */
const CATEGORY_VARS = Array.from(
  { length: VISUAL_TOKEN_ROLE_REGISTRY["butler-identity"].slotCount },
