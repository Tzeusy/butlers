...
| **locust** | `locust -f locustfile.py --host http://localhost:41100` | Ramp-up load with user simulation |
| **wrk** | `wrk -t4 -c10 -d30s http://localhost:41100/sse` | Raw SSE connection throughput |
| **hey** | `hey -n 100 -c 5 http://localhost:41103/sse` | Quick latency distribution |
...
async def main():
    ...
    print("Switchboard: http://localhost:41100/sse")
    print("Health:      http://localhost:41103/sse")
    try:
