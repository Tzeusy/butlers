...
> **Scope:** Communication interfaces and protocol contracts.
> **Belongs here:** MCP tool patterns, ingestion envelope format, dashboard REST API, inter-butler communication.
> **Does NOT belong here:** Full OpenAPI schemas (those belong in code), module internals.
