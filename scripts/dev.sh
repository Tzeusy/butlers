...
#   port (41200). If not running, it attempts to start it automatically.
#
#   Prerequisites:
...
#   - dashboard UI path -> Vite frontend port (configurable; default 41173)
#   - API path          -> dashboard API port (41200)
