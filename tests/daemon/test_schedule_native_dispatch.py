...
class TestNativeScheduleDispatch:
    ...
    async def test_memory_consolidation_job_reuses_daemon_spawner(self, tmp_path) -> None:
        """The deterministic handler binds this daemon's live Spawner to memory runtime."""
        ...
        runtime = register_memory_maintenance_runtime(
            "general",
            pool_resolver=lambda: daemon.db.pool,
        ...
        try:
            ...
            unregister_memory_maintenance_runtime("general", runtime)
