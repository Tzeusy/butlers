...
def test_calendar_non_post_token_response_never_proves_token_revocation(url: str) -> None:
    """Calendar data APIs must not promote a payload-shaped transient failure."""
