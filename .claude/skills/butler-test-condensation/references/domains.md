...
## Current cycle baseline (captured 2026-08-24)

This is the dated baseline for the active condensation cycle, captured from the
then-current `main` checkout. It is intentionally separate from the historical
