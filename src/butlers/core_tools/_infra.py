...
def register_infra_tools(ctx: ToolContext, mcp: Any, _core_tool: Callable) -> None:
    ...
    async def correct(
        ...
        registered_butlers = _registered_butler_names()
