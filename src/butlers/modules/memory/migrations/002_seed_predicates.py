...
def upgrade() -> None:
    ...
    _insert_predicate(
        "preference", None, None, False, False,
        "Food, activities, interests, dislikes",
        "relationship", "active", None, _example_clause("preference"),
    )
    _insert_predicate(
        "birthday", "person", None, False, False,
        "Date of birth",
        "relationship", "active", None, _example_clause("birthday"),
    )
    _insert_predicate(
        "lives_in", "person", None, False, False,
        "City or location",
        "relationship", "active", None, _example_clause("lives_in"),
    )

    # -- Global-scoped general predicates (retained from 005) --
    _insert_predicate(
        "goal", None, None, False, False,
        "Personal or project goal",
        "global", "active", None, _example_clause("goal"),
    )
    _insert_predicate(
        "resource", None, None, False, False,
        "Useful link, article, or tool",
        "global", "active", None, _example_clause("resource"),
    )
    _insert_predicate(
        "idea", None, None, False, False,
        "Brainstorming note or future plan",
        "global", "active", None, _example_clause("idea"),
    )
    _insert_predicate(
        "note", None, None, False, False,
        "General observation or reminder",
        "global", "active", None, _example_clause("note"),
    )
    _insert_predicate(
        "deadline", None, None, False, False,
        "Time-sensitive task or date",
        "global", "active", None, _example_clause("deadline"),
    )
    _insert_predicate(
        "status", None, None, False, False,
        "Current state of a project or activity",
        "global", "active", None, _example_clause("status"),
    )
    _insert_predicate(
        "recommendation", None, None, False, False,
        "Recommendation for a place, book, tool, etc.",
        "global", "active", None, _example_clause("recommendation"),
    )

    # -- Global-scoped edge predicates (retained from 005) --
    # knows, lives_with, sibling_of: is_symmetric=true (from 025c)
    _insert_predicate(
        "knows", "person", "person", True, False,
        "Social connection between two people",
        "global", "active", None, _example_clause("knows"),
        is_symmetric=True,
    )
    _insert_predicate(
        "works_at", "person", "organization", True, False,
        "Employment relationship",
        "global", "active", None, _example_clause("works_at"),
    )
    _insert_predicate(
        "lives_with", "person", "person", True, False,
        "Cohabitation relationship",
        "global", "active", None, _example_clause("lives_with"),
        is_symmetric=True,
    )
    # manages: inverse_of='managed_by' (from 025c)
    _insert_predicate(
        "manages", "person", "person", True, False,
        "Management relationship",
        "global", "active", None, _example_clause("manages"),
        inverse_of="managed_by",
    )
    # parent_of: inverse_of='child_of' (from 025c)
    _insert_predicate(
        "parent_of", "person", "person", True, False,
        "Parent-child relationship",
        "global", "active", None, _example_clause("parent_of"),
        inverse_of="child_of",
    )
    _insert_predicate(
        "sibling_of", "person", "person", True, False,
        "Sibling relationship",
        "global", "active", None, _example_clause("sibling_of"),
        is_symmetric=True,
    )

    # -- Inverse predicates added by 025c --
    _insert_predicate(
        "child_of", "person", "person", True, False,
        "Inverse of parent_of",
        "global", "active", None, "NULL",
        inverse_of="parent_of",
    )
    _insert_predicate(
        "managed_by", "person", "person", True, False,
        "Inverse of manages",
        "global", "active", None, "NULL",
        inverse_of="manages",
    )
    ...
    _insert_predicate(
        "medication_frequency", None, None, False, False,
        "How often a medication is taken",
        "health", "deprecated", "medication", "NULL",
    )
    _insert_predicate(
        "dosage", None, None, False, False,
        "Amount per dose",
        "health", "deprecated", "medication", "NULL",
    )
    _insert_predicate(
        "condition_status", None, None, False, False,
        "Active, managed, or resolved condition",
        "health", "deprecated", "condition", "NULL",
    )
    _insert_predicate(
        "symptom_pattern", None, None, False, False,
        "Recurring symptoms or triggers",
        "health", "deprecated", "symptom", "NULL",
    )
    _insert_predicate(
        "symptom_trigger", None, None, False, False,
        "What causes or worsens a symptom",
        "health", "deprecated", "symptom", "NULL",
    )
    _insert_predicate(
        "measurement_baseline", None, None, False, False,
        "Typical or target measurement values",
        "health", "deprecated", "measurement_weight", "NULL",
    )
    _insert_predicate(
        "dietary_restriction", "person", None, False, False,
        "Food allergies or dietary restrictions",
        "health", "deprecated", "condition", "NULL",
    )
    _insert_predicate(
        "food_allergy", "person", None, False, False,
        "Food allergy or intolerance",
        "health", "deprecated", "condition", "NULL",
    )
    _insert_predicate(
        "allergy", "person", None, False, False,
        "Medication or substance allergy",
        "health", "deprecated", "condition", "NULL",
    )
    _insert_predicate(
        "exercise_routine", "person", None, False, False,
        "Regular physical activity",
        "health", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "doctor_name", "person", None, False, False,
        "Healthcare provider name",
        "health", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "pharmacy", "person", None, False, False,
    ...
    _insert_predicate(
        "relationship_to_user", "person", None, False, False,
        "Relationship label to the user",
        "relationship", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "contact_phone", "person", None, False, False,
        "Phone number",
        "relationship", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "contact_email", "person", None, False, False,
        "Email address",
        "relationship", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "workplace", "person", None, False, False,
        "Company or organization name",
        "relationship", "deprecated", "works_at", "NULL",
    )
    _insert_predicate(
        "relationship_status", "person", None, False, False,
        "Married, single, dating, etc.",
        "relationship", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "children", "person", None, False, False,
        "Names and ages of children",
        "relationship", "deprecated", "parent_of", "NULL",
    )
    _insert_predicate(
        "nickname", "person", None, False, False,
        "Preferred name or alias",
        "relationship", "deprecated", None, "NULL",
    )
    _insert_predicate(
        "travel_intent", "person", None, False, False,
        "Planned or potential travel",
        "relationship", "deprecated", "life_event", "NULL",
    )
    _insert_predicate(
        "anniversary", "person", None, False, False,
        "Date-based milestone",
        "relationship", "deprecated", "life_event", "NULL",
    )
    _insert_predicate(
        "current_interest", None, None, False, False,
        "Hobbies, projects, topics being explored",
        "relationship", "deprecated", "activity", "NULL",
    )
    _insert_predicate(
        "current_project", None, None, False, False,
    ...
    # =========================================================================
    _insert_predicate(
        "meal_breakfast", "person", None, False, True,
        "Breakfast meal eaten at specific time",
        "global", "active", None, "NULL",
    )
    _insert_predicate(
        "meal_lunch", "person", None, False, True,
        "Lunch meal eaten at specific time",
        "global", "active", None, "NULL",
    )
    _insert_predicate(
        "meal_dinner", "person", None, False, True,
        "Dinner meal eaten at specific time",
        "global", "active", None, "NULL",
    )
    _insert_predicate(
        "meal_snack", "person", None, False, True,
    ...
    _insert_predicate(
        "measurement_weight", None, None, False, True,
        "Health measurement: body weight. Metadata: {value, unit, notes}.",
        "health", "active", None, _example_clause("measurement_weight"),
    )
    _insert_predicate(
        "measurement_blood_pressure", None, None, False, True,
        "Health measurement: blood pressure. Metadata: {value, unit, notes}.",
        "health", "active", None, _example_clause("measurement_blood_pressure"),
    )
    _insert_predicate(
        "measurement_heart_rate", None, None, False, True,
        "Health measurement: heart rate. Metadata: {value, unit, notes}.",
        "health", "active", None, _example_clause("measurement_heart_rate"),
    )
    _insert_predicate(
        "measurement_blood_sugar", None, None, False, True,
        "Health measurement: blood sugar / glucose. Metadata: {value, unit, notes}.",
        "health", "active", None, _example_clause("measurement_blood_sugar"),
    )
    _insert_predicate(
        "measurement_temperature", None, None, False, True,
        "Health measurement: body temperature. Metadata: {value, unit, notes}.",
        "health", "active", None, _example_clause("measurement_temperature"),
    )
    _insert_predicate(
        "symptom", None, None, False, True,
        "A symptom occurrence. Content = symptom name. Metadata: {severity, condition_id, notes}.",
        "health", "active", None, _example_clause("symptom"),
    )
    _insert_predicate(
        "took_dose", None, None, False, True,
        "A medication dose event. Content = medication name. "
        "Metadata: {medication_id, skipped, notes}.",
        "health", "active", None, _example_clause("took_dose"),
    )

    # Property health predicates (re-seeded in 009 with richer descriptions)
    _insert_predicate(
        "medication", None, None, False, False,
        "Current medication. Content = ''{name} {dosage} {frequency}''. "
        "Metadata: {name, dosage, frequency, schedule, active, notes}.",
        "health", "active", None, _example_clause("medication"),
    )
    _insert_predicate(
        "condition", None, None, False, False,
        "A health condition. Content = ''{name}: {status}''. "
        "Metadata: {name, status, diagnosed_at, notes}.",
        "health", "active", None, _example_clause("condition"),
    )
    _insert_predicate(
        "research", None, None, False, False,
        "A health research note. Content = research text. "
        "Metadata: {title, tags, source_url, condition_id}.",
        "health", "active", None, _example_clause("research"),
    )
    ...
    # =========================================================================
    _insert_predicate(
        "transaction_debit", "person", None, False, True,
        "Debit (money-out) transaction event, content = merchant amount currency",
        "finance", "active", None, _example_clause("transaction_debit"),
    )
    _insert_predicate(
        "transaction_credit", "person", None, False, True,
        "Credit (money-in / refund) transaction event, content = merchant amount currency",
        "finance", "active", None, _example_clause("transaction_credit"),
    )
    _insert_predicate(
        "account", "person", None, False, False,
        "Financial account, content = institution type ****last_four",
        "finance", "active", None, _example_clause("account"),
    )
    _insert_predicate(
        "subscription", "person", None, False, False,
        "Recurring service subscription, content = service amount/frequency",
        "finance", "active", None, _example_clause("subscription"),
    )
    _insert_predicate(
        "bill", "person", None, False, False,
        "Payable bill obligation, content = payee amount due due_date",
        "finance", "active", None, _example_clause("bill"),
    )
    ...
    _insert_predicate(
        ...
        "relationship", "active", None, _example_clause("loan"),
    )
    _insert_predicate(
        "contact_task", "person", None, False, False,
        "Task scoped to a contact. Content = title. "
        "Metadata: {description, completed, completed_at}. "
        "Supersession per contact entity + subject key.",
        "relationship", "active", None, _example_clause("contact_task"),
    )
    _insert_predicate(
        "reminder", "person", None, False, False,
        "Reminder for a contact. Content = message. "
        "Metadata: {type, cron, due_at, dismissed}. "
        "Supersession per contact entity + subject key.",
        "relationship", "active", None, _example_clause("reminder"),
    )
    ...
    # Travel domain
    _insert_predicate(
        "preferences:travel_flight_seat", "person", None, False, False,
        "User preference: in-flight seat type (aisle, window, or middle).",
        "travel", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:travel_flight_class", "person", None, False, False,
        "User preference: flight cabin class (economy, business, or first).",
        "travel", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:travel_hotel_type", "person", None, False, False,
        "User preference: hotel style (boutique, chain, budget, luxury, etc.).",
        "travel", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:travel_airline", "person", None, False, False,
        "User preference: preferred airline or alliance.",
        "travel", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:travel_meal", "person", None, False, False,
    ...
    _insert_predicate(
        "preferences:health_dietary_restriction", "person", None, False, False,
        "User preference: foods or ingredients to avoid (allergies, intolerances, or ethical).",
        "health", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:health_dietary_preference", "person", None, False, False,
        "User preference: food preferences (cuisines, flavors, dietary style).",
        "health", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:health_exercise_preference", "person", None, False, False,
        "User preference: preferred exercise types or workout styles.",
        "health", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:health_measurement_unit", "person", None, False, False,
    ...
    _insert_predicate(
        "preferences:finance_currency", "person", None, False, False,
        "User preference: preferred display currency (e.g. USD, EUR, GBP).",
        "finance", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:finance_budget_period", "person", None, False, False,
        "User preference: budget cycle period (weekly, monthly, or yearly).",
        "finance", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:finance_rounding", "person", None, False, False,
    ...
    _insert_predicate(
        "preferences:relationship_communication_style", "person", None, False, False,
        "User preference: preferred interpersonal communication style (formal, casual, etc.).",
        "relationship", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:relationship_contact_frequency", "person", None, False, False,
        "User preference: how often to reach out to contacts (weekly, monthly, etc.).",
        "relationship", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:relationship_birthday_reminder_days", "person", None, False, False,
    ...
    _insert_predicate(
        "preferences:home_temperature_unit", "person", None, False, False,
        "User preference: temperature display unit (celsius or fahrenheit).",
        "home", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:home_comfort_temperature", "person", None, False, False,
        "User preference: preferred indoor temperature (numeric value with unit).",
        "home", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:home_wake_time", "person", None, False, False,
        "User preference: usual wake-up time (ISO-8601 time, e.g. 07:00).",
        "home", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:home_sleep_time", "person", None, False, False,
    ...
    _insert_predicate(
        "preferences:general_communication_style", "person", None, False, False,
        "User preference: preferred communication style with the butler "
        "(formal, casual, concise, or detailed).",
        "global", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:general_language", "person", None, False, False,
        "User preference: preferred language for responses.",
        "global", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:general_timezone", "person", None, False, False,
        "User preference: preferred timezone (IANA tz name, e.g. America/New_York).",
        "global", "active", None, "NULL",
    )
    _insert_predicate(
        "preferences:general_name", "person", None, False, False,
