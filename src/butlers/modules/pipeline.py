...
class MessagePipeline:
            ...
            async with conn.transaction():
                ...
                if existing is not None:
                    ...
                    row = await conn.fetchrow(
                        ...
                        """,
                        received_at,
                        json.loads(json.dumps(request_context, default=str)),
                        json.loads(json.dumps(raw_payload, default=str)),
                        message_text,
                    )
                    if row is None:
                        return None
    ...
    def _json_param(payload: Any) -> Any:
        """Return *payload* as-is; the asyncpg JSONB codec handles encoding."""
        return payload
