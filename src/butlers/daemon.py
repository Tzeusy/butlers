...
class ButlerDaemon:
    ...
    async def _dispatch_scheduled_task(
        ...
        *,
        ...
        if self.db is not None and job_name is not None:
            from butlers.scheduled_jobs import MEMORY_MAINTENANCE_JOB_NAMES

            if job_name.strip() in MEMORY_MAINTENANCE_JOB_NAMES:
