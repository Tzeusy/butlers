...
- [x] Write butler-switchboard spec (from switchboard_butler.md, route_inbox.py, buffer.py, audit.py, roster/switchboard/)
- [x] Write connector-base-spec (from interface.md, heartbeat.py, metrics.py, mcp_client.py, contracts.py)
...
- [x] Write butler-base-spec (from roster/, role docs)
...
- [x] Write design.md
- [x] Write tasks.md
- [x] Review specs for cross-capability consistency
- [x] Sync to main specs via `/opsx:sync`
- [x] Archive change via `/opsx:archive`
