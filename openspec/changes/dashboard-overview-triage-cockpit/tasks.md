...
- [ ] 2.4 Ensure all five surfaces have explicit empty, loading, and error states.
- [ ] 2.5 Preserve the six-field `GET /api/dashboard/briefing` public response contract.
...
- [ ] 3.4 Test empty/loading/error state rendering for attention, Operations, and Now.
- [ ] 3.5 Assert no new dashboard aggregation endpoint client is introduced for the Overview.
