...
- [ ] 7.1 Create `roster/home/butler.toml`: name=home, port=41108, schema=home, codex runtime, max_concurrent_sessions=3, switchboard registration, modules (home_assistant with URL, memory, contacts with Google sync, approvals), scheduled jobs (weekly-energy-digest, environment-report, device-health-check, memory-consolidation, memory-episode-cleanup)
