...
## Purpose
Defines the routing accuracy evaluation, per-model scoring, per-category breakdown, and confusion matrix contract for cross-model benchmark routing analysis.
