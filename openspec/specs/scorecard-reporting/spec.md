...
## Purpose
Defines the output directory structure, cross-model summary table, machine-readable results, cost summary, and terminal output contract for benchmark scorecard generation.
